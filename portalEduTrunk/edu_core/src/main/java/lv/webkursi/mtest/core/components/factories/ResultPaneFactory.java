...
public class ResultPaneFactory extends CompositeComponentFactory {
	...
	public Component getComponent(Resource rComponent) {
        ...
        Resource rSource = rComponent.getRequiredProperty(MTEST.source).getResource();
        ...
        Resource rMapper = rComponent.getRequiredProperty(MTEST.resultMapper).getResource();
